                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="{{ route('customer.credit') }}">Customers Credit</a></li>
                                    <li><a href="{{ route('customer.paid') }}">Customers Paid</a></li>
                                    <li><a href="{{ route('customer.wise.report') }}">Customers Wise Repprt</a></li>
                                </ul>
                            </li>
