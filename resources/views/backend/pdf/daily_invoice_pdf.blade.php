                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $items['payment']['customer']['name'] }}</td>
                                        <td class="text-center">#{{ $items->invoice_no }}</td>
                                        <td class="text-center">{{ date('d-m-Y', strtotime($items->date)) }}</td>
                                        <td class="text-center">{{ $items->description }}</td>
                                        <td class="text-center">{{ number_format($items['payment']['total_amount']) }}</td>  
                                    </tr>
                                    @php
                                    $total_sum += $items['payment']['total_amount'];
                                    @endphp
                                    @endforeach
                                    <tr>
                                        <td class="no-line"></td>
