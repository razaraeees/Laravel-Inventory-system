...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
                        ...
                        <div class="">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    @php
                                    $total_sum = '0';
                                    $invoice_details = App\Models\InvoiceDetail::where('invoice_id',$payment->invoice_id)
                                    ->get();
                                    @endphp
         ...
         @php
             $payment_detail = App\Models\PaymentDetail::where('invoice_id', $payment->invoice_id)->get();
         @endphp                           
                            @foreach ($payment_detail as $item)
                                <tr>
                                    <td colspan="4" style="text-align: center; font-weight: bold;">{{ date('d-m-Y', strtotime($item->date)) }}</td>
                                    <td colspan="3" style="text-align: center; font-weight: bold;">{{ number_format($item->current_paid_amount) }}</td>
                                </tr>
                            @endforeach   
